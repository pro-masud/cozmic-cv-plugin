...
use Wowaddons\Admin\WidgetsMap\Init as Init;
...
<div class="wowaddons-wrapper">
    <div class="wowaddons-dashboard-panel">
        <div class="shortcode_list">
            <div class="shortcode_tab">
                <form action="" method="POST" id="wowaddons-admin-action-form" enctype="multipart/form-data">
                    ...
                    <div  class="shortcode_tab_container">
                        ...
                        <div class="shortcode_tab_info">
                                ...
                                <?php foreach($all_widgets as $key=>$value):
                                    ...
                                    <div class="grid-item <?php echo esc_attr($value['filter']); ?>">
                                        <div class="shortcode_item">
                                            ...
                                            <?php if($value['demo'] != ''){ ?>
                                                <a href="<?php echo esc_url($value['demo']);?>" target="_blank" class="wowaddons-demo-link"><?php esc_html_e('Demo', 'wowaddons');?></a>
                                            <?php } ?>

                                            <div class="switch">
                                            <input id="wowaddons-toggle-<?php echo $key; ?>" <?php echo $checked; ?>
                            ...
                            <button class="wowaddons-admin-action-form-submit"><div class="wowaddons-spinner"></div><?php esc_html_e('Save Changes', 'wowaddons'); ?></button>
                        </div>

                        <div class="shortcode_tab_info">
                            <div class="wowaddons-dashboard-integrations">
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="wowaddons-dashboard-integration-mailchimp">
                                            <?php $mailchimp_api = Utils::get_option('wowaddons_options', 'mailchimp_api'); ?>
                                            <h2><?php esc_html_e('Mailchimp Api Key', 'wowaddons'); ?></h2>
