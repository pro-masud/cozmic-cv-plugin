...
function import_files()
{
    return [
        [
            'import_file_name'           => 'Cozmiq',
            'categories'                   => 'cozmiq',
            'local_import_file'            => trailingslashit(COZMIQ_CV_ROOT_PATH) . 'demo-import/demo-data/content.xml',
            'local_import_customizer_file'     => trailingslashit(COZMIQ_CV_ROOT_PATH) . 'demo-import/demo-data/customize.dat',
            'local_import_widget_file'     => trailingslashit(COZMIQ_CV_ROOT_PATH) . 'demo-import/demo-data/widgets.wie',
            'local_import_json' => array(
                array(
                    'file_path'     => trailingslashit(COZMIQ_CV_ROOT_PATH) . 'demo-import/demo-data/theme-settings.json',
                    'option_name'   => 'cozmiq_theme_options',
                ),
            ),
            ...
            'preview_url'   => 'https://cozmiqwp.pixel-plus.com/'
        ],
    ];
}
