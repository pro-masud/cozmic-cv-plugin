...
namespace Elementor;
class Cozmiq_About_Us_Widget extends Widget_Base {
    ...
    {
        return 'cozmiq-theme-about-us-widget';
    }
...
Plugin::instance()->widgets_manager->register(new Cozmiq_About_Us_Widget());